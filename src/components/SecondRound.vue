<template>
  <div v-if="timeLeft > 0" class="text-center">
    <div>
      <div class="mx-auto bg-white border-2 rounded-md shadow-md border-emerald-800 max-w-prose">
        <div class="relative px-4 pt-3 pb-2">
          ...
          <div class="flex flex-col px-6 pt-12 space-y-4">
            ...
            <div class="px-2 mx-auto rounded-md bg-amber-100 w-fit">
              <span class="text-xs font-bold text-gray-800 uppercase">{{ catGram }}</span>
            </div>
            <div class="relative mx-auto w-fit">
              <span class="text-xl font-medium text-gray-700">{{ definition }}</span>
            ...
            <div class="flex items-center space-x-4">
              <div>
                ...
                >
                  ...
                  <span class="absolute px-1 py-px text-xs font-bold text-white rounded-full -top-1 -right-1 bg-amber-500">
                    {{ 3 - hintsUsed }}
                  </span>
                </button>
              </div>
    ...
    <div class="mt-8">
      <span class="text-xl italic font-bold text-emerald-50 font-poppins">La Rivière des espoirs déchûs</span>
